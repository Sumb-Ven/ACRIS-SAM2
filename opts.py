...
def get_args_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--clip_version", type=str, default='CS-ViT-B/16', help="CLIP model version (e.g., 'ViT-B/16'). If None, CLIP is not loaded.")
    parser.add_argument("--adaptformer_stages", nargs="+", type=int, default=[2,3], help="Adapter/AdaptFormer stages to enable (model-specific).")
